...
class ItemResourceIT {
    ...
    private static final Instant DEFAULT_FOUND_AT = Instant.ofEpochMilli(0L);
    private static final Instant UPDATED_FOUND_AT = Instant.now().truncatedTo(ChronoUnit.MILLIS);
    ...
    void createItem() throws Exception {
        ...
        assertThat(testItem.getFoundAt()).isEqualTo(DEFAULT_FOUND_AT);
        assertThat(testItem.getLat()).isEqualTo(DEFAULT_LAT);
        assertThat(testItem.getLon()).isEqualTo(DEFAULT_LON);
    }
    ...
    @Test
    @Transactional
    void checkFoundAtIsRequired() throws Exception {
        int databaseSizeBeforeTest = itemRepository.findAll().size();
        // set the field null
    ...
    void getAllItems() throws Exception {
        ...
        restItemMockMvc
            ...
            .andExpect(jsonPath("$.[*].foundAt").value(hasItem(DEFAULT_FOUND_AT.toString())))
    ...
    void getItem() throws Exception {
        ...
        restItemMockMvc
            ...
            .andExpect(jsonPath("$.foundAt").value(DEFAULT_FOUND_AT.toString()))
    ...
    void putNewItem() throws Exception {
        ...
        updatedItem.title(UPDATED_TITLE).description(UPDATED_DESCRIPTION).foundAt(UPDATED_FOUND_AT).lat(UPDATED_LAT).lon(UPDATED_LON);
        ...
        assertThat(testItem.getFoundAt()).isEqualTo(UPDATED_FOUND_AT);
        assertThat(testItem.getLat()).isEqualTo(UPDATED_LAT);
        assertThat(testItem.getLon()).isEqualTo(UPDATED_LON);
    }
    ...
    void partialUpdateItemWithPatch() throws Exception {
        ...
        partialUpdatedItem.title(UPDATED_TITLE).description(UPDATED_DESCRIPTION).lon(UPDATED_LON);
